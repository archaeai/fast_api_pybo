<script>
    ...
    // 컴포넌트를 호출할 떄 전달한 파라미터 갑을 읽으려면 다음과 같이 params변수를 선언해야 한다. 
    export let params = {}
    let question_id = params.question_id
// answers를 참조하기떄문에 {}에서 {answers:[]}이렇게 변경해야한다. 
    ...
    <div class="card my-3">
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-end">
                ...
                <div class="badge bg-secondary text-dark p-2 text-start">
